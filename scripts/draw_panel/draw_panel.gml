...
draw_sprite_part_ext(sid, ii, size, size, iw, ih, xx + size, yy +  size,(w-size*2)/iw, (h-size*2)/ih, c_white, a);
draw_sprite_part_ext(sid, ii, 0, size, size, 1, xx, yy +  size, 1, h-size*2, c_white, a);
draw_sprite_part_ext(sid, ii, sw-size, size, size, 1, xx + w-size, yy +  size, 1, h-size*2, c_white, a);
draw_sprite_part_ext(sid, ii, size, 0, 1, size, xx+size, yy, w-size*2, 1, c_white, a);
draw_sprite_part_ext(sid, ii, size, sh-size, 1, size, xx+size, yy + h-size, w-size*2, 1, c_white, a);
